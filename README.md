...
## Rosetta workspace docs

Generated by `init-workspace-flow` for any session (including a memoryless GOV-004 recovery session) to orient from:

- [Business context](docs/CONTEXT.md) · [Architecture](docs/ARCHITECTURE.md) · [Code map](docs/CODEMAP.md)
- [Patterns](docs/PATTERNS/INDEX.md) · [Assumptions](docs/ASSUMPTIONS.md) · [TODO](docs/TODO.md)
- [Implementation state](agents/IMPLEMENTATION.md) · [Agent memory](agents/MEMORY.md)
